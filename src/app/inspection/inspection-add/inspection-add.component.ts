    ...
    submitDetail()
    {
      ...
      getComplaintDetail(id)
      {
        ...
        getSubCatgory(row) {
          ...
          this.service.post_rqst({ 'id': row.id }, "Master/subCategoryList").subscribe((result => {
            if (result['statusCode'] == 200) {
        ...
        AddProduct(){
          this.product_data.product_name=this.product_data.product_id.product_name
          this.product_data.segment_id =this.product_data.product_id.segment_id
          this.product_data.sub_segment_id =this.product_data.product_id.sub_segment_id
          // this.add_product.push(this.product_data)
          // console.log(this.add_product);
          if(this.add_list.length <=0){
            this.add_list.push(JSON.parse(JSON.stringify(this.product_data)))
            console.log(this.add_list)
            this.product_data.qty='';
            this.product_data.segment_id='';
            this.product_data.sub_segment_id='';
